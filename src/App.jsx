...
function App() {
  ...
  const renderEpisode = useCallback((episode) => {
    ...
    return (
      <div className="px-6 md:px-10 pb-12 max-w-full">
        <div className={`fixed top-0 right-0 bg-white py-6 px-6 md:px-10 border-b border-gray-200 z-50 shadow-sm transition-all duration-300 ${sidebarOpen ? 'md:left-[280px]' : 'md:left-0'} left-0`}>
            ...
            <div className="flex items-center gap-2">
              ...
              {isSpeaking && (
                <button
                  ...
                  className="flex items-center gap-2 px-3 py-2 text-sm text-white bg-red-500 hover:bg-red-600 rounded-lg transition-colors"
        ...
        <div className="pt-[90px] md:pt-[100px] max-w-full">
          {episode.paragraphs.map((para, index) => (
            <div key={index} className="mb-8">
              <div className="mb-6">
                <div className="flex items-center justify-between mb-3">
                  ...
                  <button
                    ...
                    className="flex items-center gap-1 px-2 py-1 text-xs text-gray-600 hover:text-indigo-600 hover:bg-indigo-50 rounded transition-colors"
              ...
              <div className="pt-6 border-t border-gray-200">
                <div className="flex items-center justify-between mb-3">
                  ...
                  >
                    {isSpeaking && currentSpeakingText === para.french ? (
                      <>
                        <span className="text-red-500">⏸</span> Arrêter
                      </>
                    ) : (
                      <>
                        <span>▶</span> Lire
                ...
                <p className="text-lg leading-relaxed text-gray-600 m-0 italic">
                  {para.french}
                </p>
              </div>
            </div>
  ...
  return (
    <div className="flex min-h-screen bg-white">
      {/* Sidebar */}
      <div className={`sidebar w-[280px] bg-gray-50 border-r border-gray-200 fixed h-screen overflow-y-auto transition-transform duration-300 z-[100] ${sidebarOpen ? 'translate-x-0' : '-translate-x-full'}`}>
        <div className="sticky top-0 bg-white border-b border-gray-200 px-5 py-6 flex justify-between items-center z-10">
          <h2 className="text-xl font-semibold text-gray-900 m-0">Bilingual Reader</h2>
          <button 
            className="bg-transparent border-0 text-xl cursor-pointer text-gray-600 py-1 px-2 rounded transition-colors hover:bg-gray-100"
        ...
        <nav className="py-5">
          <div className="mb-8">
            ...
            <button
              ...
              className={`block w-full py-2.5 px-5 bg-transparent border-0 text-left text-gray-600 text-[0.95rem] font-normal cursor-pointer transition-all border-l-4 ${
                viewMode === 'summary' 
          ...
          <div className="mb-4">
            <button
              ...
              className="w-full flex items-center justify-between px-5 mb-3 bg-transparent border-0 cursor-pointer hover:bg-gray-100 py-2 rounded transition-colors"
              aria-label={episodesCollapsed ? 'Expand episodes' : 'Collapse episodes'}
            >
              <div className="text-xs font-semibold uppercase text-gray-500 tracking-wide">
                Episodes
              </div>
              <span className={`text-gray-400 text-sm transition-transform duration-200 ${episodesCollapsed ? '-rotate-90' : ''}`}>
                ▼
              </span>
            </button>
          ...
          <div className="mb-8">
            ...
            >
              ...
              <span className={`text-gray-400 text-sm transition-transform duration-200 ${commonWordsCollapsed ? '-rotate-90' : ''}`}>
                ▼
              </span>
            </button>
      ...
      <div className={`flex-1 min-h-screen bg-white relative transition-all duration-300 ${sidebarOpen ? 'md:ml-[280px]' : 'md:ml-0'} ml-0`}>
        {!sidebarOpen && (
          <button 
            className="fixed top-5 left-5 w-11 h-11 bg-white border border-gray-200 rounded-lg text-2xl cursor-pointer flex items-center justify-center shadow-md z-[100] transition-all text-gray-600 hover:bg-gray-50 hover:border-gray-300 hover:shadow-lg"
      ...
      {/* Settings Modal */}
      {showSettings && (
        <div className="fixed inset-0 bg-black bg-opacity-50 z-[200] flex items-center justify-center p-4" onClick={() => setShowSettings(false)}>
          <div className="bg-white rounded-lg shadow-xl max-w-md w-full p-6" onClick={(e) => e.stopPropagation()}>
            <div className="flex items-center justify-between mb-6">
              <h2 className="text-2xl font-bold text-gray-900">Speech Settings</h2>
              <button
            ...
            <div className="space-y-6">
              ...
              <div>
                <label className="block text-sm font-medium text-gray-700 mb-2">
                  English Voice
                  <span className="text-xs text-gray-500 ml-2">(Recommended voices appear first)</span>
                </label>
                <select
                  value={englishVoice}
